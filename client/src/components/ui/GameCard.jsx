...
export function GameCard({ title, description, path, stats }) {
  return (
    <div className="bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
      <div className="p-4">
        <div className="flex items-center justify-between">
          ...
          <Link href={path}>
            <div className="bg-secondary hover:bg-secondary/90 text-white h-12 w-12 rounded-full flex items-center justify-center shadow-md transition-colors duration-300 ml-4 cursor-pointer">
