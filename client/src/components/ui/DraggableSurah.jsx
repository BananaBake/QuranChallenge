...
export function DraggableSurah({ name, arabicName, number, index, onMoveItem, showNumber = false }) {
  ...
  const handleTouchMove = (e) => {
    ...
    // const currentY = e.touches[0].clientY; // Not used
    ...
    if (droppableBelow) {
      ...
      if (hoverIndex !== index) {
        ...
        // Update index for the moved item to avoid issues if touch move continues over it
        // This might need a more robust solution depending on how onMoveItem re-renders.
        // For now, assuming onMoveItem causes a re-render that updates the index prop.
      }
    }
  };
